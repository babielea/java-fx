...
import com.project6.gui.util.FXUtils;
...
public class MainGuiController {
    ...
    @FXML
    ListView<String> listViewJob, listViewYear;
    ...
    public void onConfirmClick() {
        ...
        if (peter.checkForLogin()) {
            ...
            listViewJob = FXUtils.getChildByID(root, "listViewJob");
            listViewYear = FXUtils.getChildByID(root, "listViewYear");

            ObservableList<String> years = FXCollections.observableArrayList();
            years.add("Erstes Jahr");
            years.add("Zweites Jahr");
            years.add("Drittes Jahr");
            listViewYear.setItems(years);
            ...
            strings.addAll(ausbildungsberufs.stream().map(Ausbildungsberuf::getBeruf).collect(Collectors.toList()));
